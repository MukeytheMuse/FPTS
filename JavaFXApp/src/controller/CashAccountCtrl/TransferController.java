 ...
 * @author ericepstein
 */
public class TransferController extends MenuController {
        ...
        selectBtn.setOnAction(new EventHandler<ActionEvent>() {
                            ...
                            public void handle(ActionEvent e) {
                                 ...
                                 if (isValid(amountField)) {
                                     ...
                                     if (cashAccount1.getValue() >= (amount)) {
                                         results.getChildren().clear();
                                         searchBtn.setVisible(true);
                                         selectBtn.setVisible(false);
                                         amountField.setVisible(false);
                                         amountDescription.setVisible(false);
                                         mainInput.setText("NEXT CASH ACCOUNT");
                                         selectDescription.setText("Next cash account");
                                         ...
                                         selectBtn.setOnAction(new EventHandler<ActionEvent>() {
                                             ...
                                             public void handle(ActionEvent event) {
                                                 ...
                                                 Command aComm = new Withdrawal(cashAccount1, amount);
                                                 ...
                                                 aComm = new Deposit(cashAccount2, amount);
                                                 aCommand.addChild(aComm);
                                                 t = (Transaction) aComm;
                                                 anotherComm = new HistoryAddition(t, history);
                                                 aCommand.addChild(anotherComm);
