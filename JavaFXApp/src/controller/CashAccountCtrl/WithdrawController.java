 ...
 * @author ericepstein
 */
public class WithdrawController extends MenuController {
        ...
        selectBtn.setOnAction(new EventHandler<ActionEvent>() {
                            ...
                            public void handle(ActionEvent e) {
                                 ...
                                 if (isValid(amountField)) {
                                     ...
                                     if (cashAccountOfInterest.getValue() >= (amount)) {
                                         results.getChildren().clear();
                                         ...
                                         Command aComm = new Withdrawal(cashAccountOfInterest, amount);
